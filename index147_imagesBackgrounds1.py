...
Pour le positionnement des widgets, il existe trois méthodes : 
pack, grid et place
pack et grid ne peuvent pas être utilisés simultanément pour un même cadre.
Par contre, place peut être utilisé simultanément avec pack ou grid 
pour un même cadre

1ère méthode :
Récupération du fichier dans l'application Paint 3D puis avec le 
'compte-goutte' récupérer la couleur du bleu ciel de l'image pour obtenir 
le code hexadécimal du fond de couleur du titre en haut de l'image et du 
...
"""Ajout d'un cadre"""
my_frame = tkinter.Frame(root, bg='#6b88fe')
my_frame.pack(pady=20)

"""Ajout de boutons"""
my_button1 = tkinter.Button(my_frame, text='Sortie')
my_button1.grid(row=0, column=0, padx=10)
my_button2 = tkinter.Button(my_frame, text='Commencer')
my_button2.grid(row=0, column=1, padx=10)
my_button3 = tkinter.Button(my_frame, text='Effacer')
