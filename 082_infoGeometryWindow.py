...
def info():
    ...
    height_label = Label(root, text='Hauteur ' + str(root.winfo_height()))
    height_label.pack(pady=20)
    width_label = Label(root, text='Largeur ' + str(root.winfo_width()))
    width_label.pack(pady=20)


"""Configuration du bouton d'exécution"""
my_button = Button(root, text='Clique moi !', command=info)
