...
En complément du précédent programme, cette fois-ci on ajoute
une barre de self.statuts en bas de fenêtre en affichant le n°
...
class GUI:
    ...
    def widgets(self):
        ...
        self.statuts = tkinter.Label(
            root, 
            text='Image 1 sur ' + str(len(self.images_list)),
            bd=1, 
            relief="sunken", 
            anchor='e')
