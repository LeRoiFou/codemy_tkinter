"""
Tkinter - Codemy.com #167 : How To Resize Your App With The Sizegrip Widget - Python Tkinter GUI Tutorial #167
Lien : https://www.youtube.com/watch?v=8lkyOGUhK8Q

Dans ce programme on apprend à redimensionner la fenêtre principale avec un nouveau widget : sizegrip
Cela permet de pouvoir redimensionner à l'intérieur de la fenêtre... pas trop d'utilité...
...
"""Configuration du nouveau widget sizegrip sous la forme d'un petit triangle"""
my_sizegrip2 = ttk.Sizegrip(my_frame2)
my_sizegrip2.pack(side='right',  # widget situé à droite de la barre de statut
...
my_frame.pack(side='bottom',  # cadre situé en bas de la fenêtre principale
              fill=X  # cadre 'étalé' sur toute la longueur de la fenêtre principale
              )

"""Configuration du nouveau widget sizegrip sous la forme d'un petit triangle"""
my_sizegrip = ttk.Sizegrip(my_frame)
my_sizegrip.pack(side='right',  # widget situé à droite de la barre de statut
                 anchor=SE  # widget ancré en bas à droite de la barre de statut
                 )
