"""
Tkinter - Codemy.com #111 : Print A File - Build A Text Editor Part 8
Lien : https://www.youtube.com/watch?v=gkWtBrVq3W8&list=PLCC34OHNcOtoC6GglhF3ncJ5rLwQrLGnV&index=111

Dans ce programme on apprend :
-> À imprimer un fichier à partir des modules ci-après et de la fonction print_file()
