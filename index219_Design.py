"""
Tkinter - Codemy.com #219 : Modern GUI Design With Tkinter
Lien : https://www.youtube.com/watch?v=JDU-ycsxvqM

Dans ce programme on modernise le design de la bibliothèque tkinter en recourant
à un nouveau module : customtkinter

Script ci-dessous copié à partir du lien suivant :
https://github.com/TomSchimansky/CustomTkinter
-> Partie examples : fichier complex_example.py
