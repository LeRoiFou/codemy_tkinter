"""
Tkinter - Codemy.com #175 : Treeview Primary Key With SQLite3 - Python Tkinter GUI Tutorial #175
Lien : https://www.youtube.com/watch?v=8y3JHCnVPMw
...
Dans ce programme on créé une clé primaire dans la méthode query_database()
en insérant l'instruction suivante : SELECT rowid, * FROM customers
Le champ ID qui était présent, prend en conséquence les valeurs de la clé primaire
