"""
Tkinter - Codemy.com #121 : Treeview Update Records - Python Tkinter GUI Tutorial #121
Lien : https://www.youtube.com/watch?v=lKiNlSs_cms&list=PLCC34OHNcOtoC6GglhF3ncJ5rLwQrLGnV&index=121

Dans ce programme on sélectionne une ligne de données saisies en recourant à la fonction select_record() et on met à
jour les données avec la fonction update_record()
