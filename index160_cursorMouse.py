"""
Tkinter - Codemy.com #160 : 
Changing The Mouse Cursor - Python Tkinter GUI Tutorial #160
...
# curseur de la souris = 4 flêches en forme de croix
...
for i in range(5):  # Total row - 5
    for j in range(4):  # Total column - 4
        tkinter.Button(
            root,
            text=my_list[count], 
            cursor=my_list[count], 
            width=10).grid(row=i, column=j, padx=10, pady=10)
        count += 1
