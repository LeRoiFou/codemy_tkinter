"""
Tkinter - Codemy.com #214 : Blackjack Draw Five Cards and Win
Lien : https://www.youtube.com/watch?v=dJ9z4eYGR7M
...
class Gui :
    ...
    def widgets(self):
        ...
        self.stand_button = tk.Button(
            button_frame, text='Servi !', font='Helvetica 14',
    ...
    def player_hit(self):
        ...
        # Si au moins de 5 cartes ont été posées
        if self.player_spot <= 5:
            try:
                ...
                # Si c'est la 5ème carte posée     
                    ...
                    # Assignation du score total obtenu par participant
                    self.player_total = 0
                    self.dealer_total = 0
                    
                    # Cumul du score obtenu à chaque carte tirée 
                    # pour le joueur
                    ...
                    # Si le cumul du score obtenu est <= à 21
                    if self.player_total <= 21:
                        # Désactivation des boutons d'exécution
                        self.card_button.config(state='disabled')
                        self.stand_button.config(state='disabled')
                        
                        # Message d'information
                        messagebox.showinfo("Le joueur a gagné !",
                                            f"Le joueur a gagné ! Croupier : {self.dealer_total} Joueur : {self.player_total}")
