...
class GUI:
    ...
    def widgets(self):
        ...
        self.myButton = tkinter.Button(root, text='Clique moi !', command=self.myClick, fg='blue', bg='#000000')
        self.myButton.pack()

    def myClick(self):
        # Fonction pour l'affichage du message
        self.myLabel = tkinter.Label(root, text="Regarde ! J'ai cliqué sur le bouton !")
        self.myLabel.pack()
