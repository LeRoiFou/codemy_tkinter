"""
Tkinter - Codemy.com #90 : MP3 Player Song Duration and Length (pt4)
Lien : https://www.youtube.com/watch?v=1zPyYf_XBD4&list=PLCC34OHNcOtoC6GglhF3ncJ5rLwQrLGnV&index=90

Création d'un lecteur mp3 virtuel

Dans ce programme, on créé :
-> un affichage du temps d'écoulement du titre avec le recours du module time
-> un affichage du temps total du titre avec le recours du package installé mutagen
