...
En complément on a recours à l'instruction "selectmode" dans le widget Listbox.
Cependant cette instruction pose problème en sélectionnant / supprimant une ou plusieurs données...
