...
-> À couper, copier et coller le texte sélectionné dans le textbox à partir du menu
-> À résoudre l'anomalie du programme lorsque par exemple on copie avec les touches CTRL + X et on colle avec le menu :
Édition -> coller, qui fait ressortir une erreur de programmation, en recourant à l'instruction bind
-> Coordonner les touches de raccourcis du clavier pour couper/copier/coller avec les fonctions présentes dans le menu
Editer
