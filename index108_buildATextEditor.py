"""
Tkinter - Codemy.com #108 : 
Build A Text Editor Part 5 - Undo Redo and Horizontal Scrollbar
Lien : https://www.youtube.com/watch?v=XW65JTd8UgI&list=PLCC34OHNcOtoC6GglhF3ncJ5rLwQrLGnV&index=108

Dans ce programme on appr'end' :
-> À aligner les mots 'ctrl+x' pour couper, ..., 
avec l'instruction accelerator
-> À annuler et à rétablir sans recourir aux fonctions 
comme pour couper/copier/coller
-> À créer une barre de défilement horizontale dont l'instruction wrap=None 
lors de l'initialisation du textbox, qui permet de ne pas revenir en début
de ligne dès qu'on est arrivé au bout du champ de saisi
...
class Gui:
    ...
    def save_as_file(self):
        ...
        """Rectification des instructions ci-avant : 
        ici on n'a pas appliqué la condition if..."""
    ...
    def cut_text(self, e):
        ...
        if e:
            ...
            """Les instructions ci-après permettent de couper 
            le texte sélectionner à partir du menu Fichier -> Couper"""
    ...
    def copy_text(self, e):
        ...
        à chaque fois que l'on fait un copier/couper/coller, 
        ...
        était conservée dans le presse-papier, ce qui arrive de temps en temps
        dans LibreOffice..."""
        ...
        if e:
            ...
            le texte sélectionné à partir du menu Fichier -> Copier"""
