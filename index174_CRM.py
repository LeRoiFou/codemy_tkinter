"""
Tkinter - Codemy.com #174 : Connect Treeview To Database - Python Tkinter GUI Tutorial #174
Lien : https://www.youtube.com/watch?v=pSXlKihUTlU
...
Dans le script ci-dessous on a recours à la base de données avec le module sqlite3
