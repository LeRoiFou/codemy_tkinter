"""
Tkinter - Codemy.com #209 : Blackjack Check For Tie/Push
Lien : https://www.youtube.com/watch?v=1hPb7nLpW6E

Dans ce programme on apprend à créer un jeu de cartes :p
Cette fois-ci on créé le jeu du black jack

Dans ce fichier, on ajoute un dictionnaire et un résultat
est donné aussi bien si le dealer que le player a gagné
que s'ils sont ex-aequo ;)
...
class Gui :
    ...
    def blackjack_shuffle(self, player):
        ...
        if len(self.dealer_score) == 2 and len(self.player_score) == 2:
            ...
            # Si le score des 2 cartes des 2 participants est de 21 points
