"""
Tkinter - Codemy.com #94 : Volume Control (MP3 Player | Part 8)
Lien : https://www.youtube.com/watch?v=3MLCsVRRKD4&list=PLCC34OHNcOtoC6GglhF3ncJ5rLwQrLGnV&index=94

Création d'un lecteur mp3 virtuel

Dans ce programme :
-> création d'un cadre pour les widgets (box de la playlist, curseur et barre de statut) distinct du cadre ETIQUETTE
pour le curseur du volume
-> création d'une fonction volume() pour diminuer ou augmenter le son
-> affichage provisoire du niveau du volume inséré dans les fonction play() et volume()
...
def play():
    ...
    slider_label.config(text=current_volume * 100)  # affichage du niveau actuel du volume
...
def volume(*args):
    ...
    # current_volume = pygame.mixer.music.get_volume()  # déclaration d'une variable pour le niveau du volume
    # slider_label.config(text=current_volume * 100)  # affichage du niveau du volume
