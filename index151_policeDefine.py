...
Dans ce programme on apprend à utiliser différents types 
de police d'écritures sur les widgets
...
"""Bouton """
my_button1 = tkinter.Button(root, text='Grand texte', font=bigFont)
...
"""Message"""
my_label = tkinter.Label(root, text='Texte plus grand', font=mediumFont)
