"""
Tkinter - Codemy.com #5 : construire une calculatrice !
Lien : https://www.youtube.com/watch?v=F5PfbC5ld-Q&list=PLCC34OHNcOtoC6GglhF3ncJ5rLwQrLGnV&index=5

Dans ce programme on apprend à afficher les widgets de la calculatrice
...
"""Affichage de fenêtre de la calculatrice sous la forme d'un widget Entry"""
...
def button_click(number):
    """Affichage des boutons cliqués sur la calculatrice"""
    # e.delete(0, 'end')
    e.insert(0, number)
