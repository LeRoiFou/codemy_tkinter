"""
Tkinter - Codemy.com #178 : Delete All Database Record And Drop Table - Python Tkinter GUI Tutorial #179
Lien : https://www.youtube.com/watch?v=tkBpehUruZ4
...
Dans ce programme on supprime toutes les données du SGBD
Avant cela, un message d'alerte demande la confirmation si on veut tout supprimer
À chaque fois qu'on intervient dans le SGBD, on a recours au langage SQL avec l'instruction c.execute()
