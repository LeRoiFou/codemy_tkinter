...
Dans ce cas là on a recours au widget Canvas par contre on a plus recours à l'instruction fg pour la couleur d'écriture
et le placement des widgets ne requiert plus d'utiliser les instructions pack, grid ou place...
Cette méthode est plus complexe notamment pour positionner les widgets au bon endroit, car l'instruction grid avec row
et column facilite largement l'emplacement des widgets notamment lorsqu'on attribue un cadre spécifique à certains
widgets
