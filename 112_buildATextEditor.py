"""
Tkinter - Codemy.com #112 : Select All and Clear - Build A Text Editor Part 9
...
-> À sélectionner tout le texte avec la fonction select_all(e) : fonction paramétrée car en liaison avec les touches de
raccourcis 'ctrl+a'
-> À supprimer tout le texte avec la fonction clear_all()
